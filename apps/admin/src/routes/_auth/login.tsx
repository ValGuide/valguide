      ...
      <div className="mx-auto flex w-full max-w-sm flex-col items-center gap-6 p-6">
        ...
        >
          <svg viewBox="0 0 24 24" className="size-5" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M18.956 8.834a2.528 2.528 0 0 1 2.522-2.521A2.528 2.528 0 0 1 24 8.834a2.528 2.528 0 0 1-2.522 2.521h-2.522V8.834zm-1.27 0a2.527 2.527 0 0 1-2.523 2.521 2.527 2.527 0 0 1-2.52-2.521V2.522A2.527 2.527 0 0 1 15.163 0a2.527 2.527 0 0 1 2.523 2.522v6.312z" fill="#2EB67D"/>
