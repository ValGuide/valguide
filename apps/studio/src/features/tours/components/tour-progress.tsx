...
export function TourProgress() {
  ...
  const { tourDetail, localeDraft, stops, tourAssets } = useTourEditor()
  ...
  const items = [
    {
      label: t('progress.tourTitle'),
      complete: !!localeDraft?.title,
    },
    {
      label: t('progress.tourDescription'),
      complete: !!localeDraft?.description,
    },
    {
      label: t('progress.coverImage'),
      complete: tourAssets.some((a) => a.channel === 'images.hero'),
    },
    {
