...
import type { GuideIndicator, GuideStatus } from '@/features/guides/components/guide-status-badge'
...
export function GuideEditPage({ onPublish, onUnpublish, onHideStop, onShowStop, MediaPicker }: GuideEditPageProps) {
  ...
  const handleCoverImageChange = useCallback(
    (value: Asset | Asset[] | null) => {
      if (value === null) setGuideCover(null)
      else if (!Array.isArray(value)) setGuideCover(value)
    },
    [setGuideCover],
  )
