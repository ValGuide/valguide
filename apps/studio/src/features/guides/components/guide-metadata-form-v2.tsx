...
export type GuideMetadataFormV2Props = {
  locale: string
...
export const GuideMetadataFormV2 = forwardRef<GuideMetadataFormRef, GuideMetadataFormV2Props>(
  function GuideMetadataFormV2({ locale, versionData, onDirtyChange, onSave, readOnly }, ref) {
