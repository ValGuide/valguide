...
import { GuideEditorV2Context, type GuideEditorV2ContextValue } from './guide-editor-v2-types'
...
interface GuideEditorV2ProviderProps {
  children: ReactNode
  nanoId: string
  initialLocale?: string
}

export function GuideEditorV2Provider({ children, nanoId, initialLocale }: GuideEditorV2ProviderProps) {
  ...
  const value: GuideEditorV2ContextValue = {
    nanoId,
    guideId,
    activeLocale,
    availableLocales,
  ...
  return <GuideEditorV2Context.Provider value={value}>{children}</GuideEditorV2Context.Provider>
}
