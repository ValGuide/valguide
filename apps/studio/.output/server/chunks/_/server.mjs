...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BUCURBOE.mjs");
...
const manifest = { "8e108d9ec1b1ede177df6b4b60e65791ca136b3d699b4b3dbc8c0ab64e5014be": {
  functionName: "signInWithOtpFn_createServerFn_handler",
  importer: () => import("./actions-B2_FHces.mjs")
}, "a0356f9b16f263be68df7946d5692d56100af448e8de6abfc834121a916ecf3b": {
  functionName: "verifyOtpFn_createServerFn_handler",
  importer: () => import("./actions-B2_FHces.mjs")
}, "0e5a7d1170df968209cbae5eb87e6dccbfc28360be319df2544683c554038f80": {
  functionName: "signOutFn_createServerFn_handler",
  importer: () => import("./actions-B2_FHces.mjs")
} };
...
async function loadEntries() {
  const routerEntry = await import("./router-heQVHxAK.mjs");
