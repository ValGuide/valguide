    ...
    translations: [
        {
            ...
            description: 'Welcome to the magnificent Great Hall, built in 1872. This space has hosted countless exhibitions and gatherings.',
    ...
    translations: [
        {
            ...
            description: 'Willkommen im prächtigen Großen Saal, erbaut 1872. Dieser Raum war Schauplatz zahlreicher Ausstellungen und Veranstaltungen.',
