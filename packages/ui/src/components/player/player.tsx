...
const playerVariants = cva('flex flex-col gap-2 rounded-lg border bg-card p-4 shadow-sm', {
  variants: {
    variant: {
      default: 'w-full',
      compact: 'max-w-md',
...
const Player = React.forwardRef<HTMLDivElement, PlayerProps & DataTestIdProps>(
  (
    {
      className,
      variant,
