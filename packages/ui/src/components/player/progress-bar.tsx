      ...
      (thumbProps, thumbRef) => {
        return (
          <SliderPrimitive.Thumb ref={thumbRef} {...thumbProps} asChild>
            <motion.span
              className="block h-3.5 w-3.5 rounded-full border border-primary/50 bg-background shadow focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
              initial={{ scale: 1 }}
