...
export function ExhibitHeader({ title, museumName, onClose, className }: ExhibitHeaderProps) {
  return (
    <div className={cn('absolute top-0 left-0 right-0 z-10 flex items-center justify-between bg-gradient-to-b from-black/50 to-transparent px-6 pt-12 pb-20', className)}>
      <button 
        onClick={onClose}
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <h1 className="mt-1 text-sm font-semibold text-white shadow-black drop-shadow-md">
          {title}
        </h1>
      </div>
