  ...
  return (
    ...
    >
      <div className="shrink-0 mr-3">
        {type === 'success' ? (
          <svg aria-hidden="true" className="h-5 w-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
            <path
              fillRule="evenodd"
          ...
          <svg aria-hidden="true" className="h-5 w-5 text-red-600" fill="currentColor" viewBox="0 0 20 20">
            <path
              fillRule="evenodd"
